...
<body>
    ...
    <main class="error-card">
        ...
        <p class="description">
            Alamat yang kamu buka mungkin salah, sudah berubah, atau memang belum pernah tersedia di UMKMKita.
        </p>

        <div class="divider"></div>

        <p class="help-text">
            Kamu bisa kembali ke beranda untuk menemukan berbagai UMKM lainnya.
        </p>
