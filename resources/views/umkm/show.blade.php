                    ...
                    @foreach($umkm->posters as $poster)
                        <button type="button"
                            ...
                            <div class="catalog-image">
                                <img src="{{ asset('storage/' . $poster->image) }}" alt="{{ $poster->title ?: 'Poster ' . $umkm->name }}">
                            </div>
                                    ...
                                    <article class="standby-item">
                                        ...
                                        <div class="standby-content">
                                            ...
                                            @if($location->latitude !== null && $location->longitude !== null)
                                                <a href="https://www.google.com/maps/search/?api=1&query={{ $location->latitude }},{{ $location->longitude }}" target="_blank" rel="noopener">
                                                    Buka di Google Maps ↗
                                                </a>
                                            @endif
                                        </div>
                        ...
                        @else
                            <div class="fixed-location">
                                ...
                                @if($umkm->latitude !== null && $umkm->longitude !== null)
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ $umkm->latitude }},{{ $umkm->longitude }}" target="_blank" rel="noopener" class="google-maps-button">
                                        Buka di Google Maps ↗
                                    </a>
                                @endif
                            </div>
